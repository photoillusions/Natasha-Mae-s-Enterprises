...
const ThemedSetups = () => (
  <section className="relative min-h-[115vh] flex flex-col items-center justify-start overflow-hidden bg-stone-950">
    ...
    <div className="relative z-10 text-center px-6 max-w-6xl pt-32 pb-20">
      <h2 className="text-5xl md:text-7xl text-white font-bold leading-[1.1] tracking-tighter">Themed Set-Ups</h2>
      <p className="text-stone-300 text-lg md:text-xl max-w-3xl mx-auto font-light italic leading-relaxed opacity-80 mt-4">This page will showcase our themed event set-ups. (Content coming soon)</p>
    </div>
  </section>
);

export default ThemedSetups;
